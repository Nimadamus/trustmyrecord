...
try {
    ...
    Assert-Match "Sportsbook" $sportsbook "sportsbook-production-fix-persist-reliability\.js\?v=20260507risktowinlive5" "current reliability script include is missing."
