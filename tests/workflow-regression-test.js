...
const referencedTests = [
  'line-formatting-regression-test.js',
  'publish-guard-regression-test.js',
  'pending-picks-regression-test.js',
  'local-api-no-seed-regression-test.js',
  'pick-display-format.test.js',
  'trendspotter-source-regression-test.js',
  'trendspotter-accuracy-test.js',
  'sitewide-design-system-regression-test.js',
  'route-shim-regression-test.js',
  'sitemap-route-regression-test.js',
  'homepage-canonical-regression-test.js',
  'homepage-visual-regression-test.js',
  'feed-page-regression-test.js',
  'polls-page-visual-regression-test.js',
  'polls-create-flow-regression-test.js',
  'trivia-page-regression-test.js',
  'arena-page-visual-regression-test.js',
  'leaderboards-page-visual-regression-test.js',
  'forum-page-visual-regression-test.js',
  ...
  'sportsbook-header-regression-test.js',
  'sportsbook-polish-regression.test.js',
  'sportsbook-stake-mode-ui-test.js',
  'sportsbook-first-inning-yesno-lock-test.js',
  'protected-baseline-regression-test.js',
  'auto-grader-regression-test.js',
  'profile-page-lookup-test.js',
  'profile-no-old-theme-flash-test.js',
  'profile-source-regression-test.js',
  'profile-market-drilldown-page-test.js',
  'mlb-simulator-page-test.js',
  'mlb-simulator-boxscore-test.js',
  'mlb-simulator-realism-test.js',
  'mlb-simulator-live-roster-validation-test.js',
...
for (const required of [
  ...
  'node tests/pick-display-format.test.js',
  'node tests/trendspotter-source-regression-test.js',
  'node tests/trendspotter-accuracy-test.js',
  'node tests/sitewide-design-system-regression-test.js',
  ...
  'node tests/homepage-visual-regression-test.js',
  'node tests/feed-page-regression-test.js',
  'node tests/polls-page-visual-regression-test.js',
  'node tests/polls-create-flow-regression-test.js',
  'node tests/trivia-page-regression-test.js',
  'node tests/arena-page-visual-regression-test.js',
  'node tests/leaderboards-page-visual-regression-test.js',
  'node tests/forum-page-visual-regression-test.js',
  ...
  'node tests/sportsbook-header-regression-test.js',
  'node tests/sportsbook-polish-regression.test.js',
  'node tests/sportsbook-stake-mode-ui-test.js',
  'node tests/sportsbook-first-inning-yesno-lock-test.js',
  'node tests/protected-baseline-regression-test.js',
