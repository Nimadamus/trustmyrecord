...
assert(html.includes('sportsbook-production-fix-persist-reliability.js?v=20260508oddsrepair2&cb=20260508gamesrestore1'), 'sportsbook page should load current sportsbook reliability script');
