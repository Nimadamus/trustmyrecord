...
const LIVE_BUNDLE = 'https://trustmyrecord.com/static/js/sportsbook-production-fix-persist-reliability.js?v=20260511compactrows2';
...
(async () => {
  ...
  assert(
    /sportsbook-production-fix-persist-reliability\.js\?v=20260511compactrows2&cb=20260511compactrows2/.test(page.body),
