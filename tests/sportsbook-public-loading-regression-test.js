...
const LIVE_BUNDLE = 'https://trustmyrecord.com/static/js/sportsbook-production-fix-persist-reliability.js?v=20260511slipcalc1';
...
(async () => {
  ...
  assert(
    /sportsbook-production-fix-persist-reliability\.js\?v=20260511slipcalc1&cb=20260511slipcalc1/.test(page.body),
