...
const LIVE_BUNDLE = 'https://trustmyrecord.com/static/js/sportsbook-production-fix-persist-reliability.js?v=20260511alignedrows2';
...
(async () => {
  ...
  assert(
    /sportsbook-production-fix-persist-reliability\.js\?v=20260511alignedrows2&cb=20260511alignedrows2/.test(page.body),
