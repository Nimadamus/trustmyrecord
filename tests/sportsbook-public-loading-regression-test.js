...
const LIVE_BUNDLE = 'https://trustmyrecord.com/static/js/sportsbook-production-fix-persist-reliability.js?v=20260511marketgrid1';
...
(async () => {
  ...
  assert(
    /sportsbook-production-fix-persist-reliability\.js\?v=20260511marketgrid1&cb=20260511marketgrid1/.test(page.body),
