...
(function () {
  ...
  function injectStyles() {
    ...
    css.id = 'tmrFiStyles';
    css.textContent = [
      '.tmr-fi-card{max-width:1100px;margin:18px auto;padding:22px;background:#FFFFFF;border:1px solid #D2DEEA;border-radius:16px;color:#07182A;font-family:Inter,system-ui,sans-serif}',
      '.tmr-fi-head{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px}',
      '.tmr-fi-head h2{font-size:18px;margin:0;color:#07182A;font-weight:800;display:flex;align-items:center;gap:9px}.tmr-fi-head h2 i{color:#07736D}',
      '.tmr-fi-edit-btn{display:inline-flex;align-items:center;gap:7px;background:rgba(12,148,140,0.12);color:#07736D;border:1px solid rgba(12,148,140,.28);border-radius:9px;padding:7px 14px;font-weight:700;font-size:13px;cursor:pointer;transition:background .15s,border-color .15s}',
      '.tmr-fi-edit-btn:hover{background:rgba(12,148,140,0.14)}',
      '.tmr-fi-edit-btn.is-active{background:#DFF3E8;border-color:rgba(10,139,78,.28);color:#04210f}',
      '.tmr-fi-badges{display:flex;flex-wrap:wrap;gap:8px;align-items:center;margin-bottom:18px}',
      '.tmr-fi-badge{display:inline-flex;align-items:center;gap:6px;padding:5px 11px;border-radius:8px;background:rgba(7,24,42,0.021);border:1px solid #D2DEEA;font-size:12px;font-weight:700}',
      '.tmr-fi-badge.is-founding{background:linear-gradient(135deg,#B98505,#B98505);border-color:rgba(185,133,5,.30);color:#B98505}',
      '.tmr-fi-personality{display:inline-flex;align-items:center;gap:6px;padding:5px 11px;border-radius:8px;background:rgba(89,64,174,0.14);border:1px solid rgba(89,64,174,.26);color:#5940AE;font-size:12px;font-weight:700}',
      // editor
      '.tmr-fi-editor{margin:0 0 18px;padding:16px;background:#FFFFFF;border:1px solid #D2DEEA;border-radius:14px;display:grid;gap:12px}',
      '.tmr-fi-editor[hidden]{display:none}',
      '.tmr-fi-ed-title{font-size:12px;text-transform:uppercase;letter-spacing:.05em;color:#2E4459;font-weight:800}',
      '.tmr-fi-banner{padding:9px 12px;border-radius:9px;font-size:12.5px;font-weight:600}.tmr-fi-banner.is-err{background:rgba(188,55,46,0.12);border:1px solid rgba(188,55,46,.28);color:#BC372E}',
      ...
      '.tmr-fi-field label{font-size:11px;font-weight:700;color:#07182A;text-transform:uppercase;letter-spacing:.03em}',
      '.tmr-fi-selwrap{position:relative}',
      '.tmr-fi-selwrap::after{content:"";position:absolute;right:12px;top:50%;width:8px;height:8px;border-right:2px solid #D2DEEA;border-bottom:2px solid #D2DEEA;transform:translateY(-65%) rotate(45deg);pointer-events:none}',
      '.tmr-fi-selwrap select{width:100%;background:#F6F9FC;color:#07182A;border:1px solid #D2DEEA;border-radius:9px;padding:10px 30px 10px 12px;font-size:14px;font-weight:600;cursor:pointer;color-scheme:light;appearance:none;-webkit-appearance:none}',
      '.tmr-fi-selwrap select:focus{outline:none;border-color:rgba(12,148,140,.28);box-shadow:0 0 0 3px rgba(7,24,42,0.061)}',
      ...
      '.tmr-fi-add--fav{background:#0C948C;color:#04121f}',
      '.tmr-fi-add--riv{background:rgba(188,55,46,0.14);color:#BC372E;border-color:rgba(188,55,46,.28)}',
      '.tmr-fi-add:disabled{opacity:.5;cursor:not-allowed;transform:none}',
      '.tmr-fi-pick-msg{font-size:12.5px;min-height:16px;font-weight:600}.tmr-fi-pick-msg.is-ok{color:#0A8B4E}.tmr-fi-pick-msg.is-err{color:#BC372E}',
      '.tmr-fi-actions{display:flex;align-items:center;gap:12px;margin-top:2px}',
      '.tmr-fi-save{background:#DFF3E8;color:#04210f;border:0;border-radius:9px;padding:10px 20px;font-weight:800;font-size:14px;cursor:pointer;transition:filter .12s}.tmr-fi-save:hover{filter:brightness(1.08)}',
      '.tmr-fi-cancel{background:transparent;color:#2E4459;border:1px solid #D2DEEA;border-radius:9px;padding:10px 18px;font-weight:700;font-size:14px;cursor:pointer;transition:border-color .12s,color .12s}.tmr-fi-cancel:hover{border-color:#D2DEEA;color:#07182A}',
      '.tmr-fi-msg{font-size:12.5px;font-weight:700}.tmr-fi-msg.is-ok{color:#0A8B4E}.tmr-fi-msg.is-err{color:#BC372E}',
      // teams columns + chips
      '.tmr-fi-teams{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:18px}',
      '.tmr-fi-teamcol{background:#FFFFFF;border:1px solid #D2DEEA;border-radius:14px;padding:14px}',
      '.tmr-fi-col-head{display:flex;align-items:center;justify-content:space-between;font-size:11px;text-transform:uppercase;letter-spacing:.05em;color:#2E4459;font-weight:800;margin-bottom:10px}',
      '.tmr-fi-col-head i{margin-right:5px}',
      '.tmr-fi-teamcol:nth-child(1) .tmr-fi-col-head i{color:#07736D}.tmr-fi-teamcol:nth-child(2) .tmr-fi-col-head i{color:#BC372E}',
      '.tmr-fi-count{background:rgba(7,24,42,0.025);color:#2E4459;border-radius:20px;min-width:20px;text-align:center;padding:1px 7px;font-size:11px}',
      ...
      '.tmr-fi-chip.is-fav{background:rgba(12,148,140,0.12);border:1px solid rgba(12,148,140,.28);color:#07736D}',
      '.tmr-fi-chip.is-rival{background:rgba(188,55,46,0.12);border:1px solid rgba(188,55,46,.28);color:#BC372E}',
      '.tmr-fi-logo{position:relative;display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;flex:0 0 20px;border-radius:5px;overflow:hidden;background:rgba(7,24,42,0.021)}',
      '.tmr-fi-logo-img{width:20px;height:20px;object-fit:contain;display:block}',
      '.tmr-fi-logo-fallback{display:none;font-size:9px;font-weight:800;letter-spacing:.02em;color:#07182A;text-transform:uppercase}',
      '.tmr-fi-logo.is-fallback .tmr-fi-logo-fallback{display:block}',
      '.tmr-fi-chip-sport{padding:1px 6px;border-radius:5px;background:rgba(7,24,42,0.042);color:#07182A;font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.03em}',
      ...
      '.tmr-fi-empty{color:#5E7590;font-size:12.5px;padding:8px 0;font-style:italic}',
      '.tmr-fi-empty-inline{color:#5E7590;font-size:12px;font-style:italic}',
      // stats
      '.tmr-fi-stats{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}',
      '.tmr-fi-stat{background:#FFFFFF;border:1px solid #D2DEEA;border-radius:12px;padding:14px;text-align:center}.tmr-fi-stat.is-soon{opacity:.72}',
      '.tmr-fi-stat-label{font-size:11px;text-transform:uppercase;letter-spacing:.04em;color:#2E4459;font-weight:700}',
      '.tmr-fi-stat-value{font-size:22px;font-weight:800;color:#07182A;margin:6px 0 2px}',
      '.tmr-fi-stat-sub{font-size:11px;color:#07736D}.tmr-fi-stat.is-soon .tmr-fi-stat-sub{color:#2E4459}',
