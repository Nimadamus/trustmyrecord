...
(function () {
  ...
  var SPORTSBOOK = [
    ...
    /* Added 2026-09-06, when tennis got its own daily lane. Same rule as the
       two above and the reason the rule exists: a per-sport door, never the
  ...
  var NOTIF_CHAIN = [
    '/static/js/config.js?v=738db2dd80a5',
    '/static/js/backend-api.js?v=365fae38a6a5',
    '/static/js/auth-persistent.js?v=11181f6ae12c',
