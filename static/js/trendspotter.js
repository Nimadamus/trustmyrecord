(function () {
  ...
  function unavailableNotices(data, selection, filteredTrends) {
    ...
    notices.push("Odds, injuries, user picks, fake users, fake records, pending picks, and recommendations are not generated by Trendspotter.");
  ...
  function renderResults(data, selection) {
    ...
    renderTrendGroup(els.teamATrends, teamATrends, "Verified Team A trends are unavailable for this matchup.");
    renderTrendGroup(els.teamBTrends, teamBTrends, "Verified Team B trends are unavailable for this matchup.");
    renderTrendGroup(els.h2hTrends, filtered.filter(categoryMatcher("h2h")), "Verified head-to-head trends are unavailable for this matchup.");
    renderTrendGroup(els.venueTrends, filtered.filter(categoryMatcher("venue")), "Verified home/road trends are unavailable for this matchup.");
    renderTrendGroup(els.formTrends, filtered.filter(categoryMatcher("form")), "Verified recent form trends are unavailable for this matchup.");
    renderTrendGroup(els.spreadTrends, filtered.filter(categoryMatcher("spread")), selection.sport === "MLB" ? "Verified run line trends are unavailable." : "Verified spread trends are unavailable for this matchup.");
    renderTrendGroup(els.totalTrends, filtered.filter(categoryMatcher("total")), "Verified total or over-under trends are unavailable for this matchup.");
  ...
  function resetResults(sport) {
    ...
    [
      ...
      el.innerHTML = unavailableCard("Select two teams or a verified matchup, then generate trends.");
    });
