...
(function () {
  ...
  var UNAVAILABLE_TEXT = 'MLB matchups are currently unavailable';
  ...
  function ticker() {
    ...
    if (baked && baked !== today) laneMsg(lane, LOADING_TEXT, '');
  ...
  function integritySweep() {
    ...
    if (lane && !lane.querySelectorAll('.gm').length) {
