...
(function () {
  ...
  /* Six rows, and deliberately no game titles among them. Listing MLB The Show,
     Madden, NBA 2K, EA FC and NHL as five separate rows made this the longest
     menu on the site, and the list grew by one every time a title was added.
     The games sit one click deeper now, on /online-games/, which is the
     directory of what there is to play. They were removed from this table only:
     every game page kept its /sports-gaming/<game>/ URL. Changed 2026-08-28. */
  var SPORTS_GAMING = [
  ...
  function menu(label, list, alsoCurrent) {
      ...
      '<div class="ds-nav-in">' +
        ...
        '<div class="ds-nav-panel">' +
          '<div class="ds-mainnav">' +
            ...
            menu('Sports Gaming', SPORTS_GAMING, SPORTS_GAMING_ALSO) +
