(function() {
    ...
    function injectStyles() {
        ...
        style.textContent = [
            ...
            '.tmr-market-side{display:grid;grid-template-columns:minmax(260px,1fr) minmax(500px,560px);align-items:start;gap:14px;}',
            '.tmr-primary-market-grid{display:grid;grid-template-columns:repeat(3,minmax(150px,1fr));gap:10px;min-width:500px;max-width:560px;padding:12px;border-radius:16px;background:rgba(5,8,13,0.48);border:1px solid rgba(255,255,255,0.07);box-shadow:inset 0 1px 0 rgba(255,255,255,0.03);}',
            ...
            '.tmr-primary-market .tmr-option-btn{min-height:74px;height:auto;padding:10px;border-radius:12px;grid-template-columns:1fr;gap:7px;justify-items:center;align-items:center;text-align:center;background:linear-gradient(180deg,rgba(35,41,51,0.98),rgba(22,27,35,0.98));}',
            '.tmr-primary-market .tmr-option-topline{display:none;}',
            '.tmr-primary-market .tmr-option-market{font-size:13px;line-height:1.12;font-weight:900;letter-spacing:0;white-space:normal;text-align:center;color:#f8fafc;}',
            ...
            '.tmr-primary-market .tmr-option-odds{font-size:20px;min-width:86px;padding:8px 12px;border-radius:10px;text-align:center;}',
            ...
            '@media (max-width:1020px){.tmr-market-side{grid-template-columns:1fr;}.tmr-primary-market-grid{max-width:none;width:100%;min-width:0;grid-template-columns:repeat(3,minmax(110px,1fr));}.tmr-market-summary{justify-content:space-between;}}',
