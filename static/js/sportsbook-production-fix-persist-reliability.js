(function() {
    ...
    function injectStyles() {
        ...
        style.textContent = [
            ...
            '.tmr-market-head{display:block;padding:20px 22px 16px;align-items:start;cursor:pointer;background:linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0));}',
            ...
            '.tmr-market-side{display:grid;grid-template-columns:minmax(260px,34%) minmax(0,1fr);align-items:start;gap:22px;width:100%;min-width:0;}',
            ...
            '.tmr-primary-market .tmr-option-btn{min-height:72px;height:auto;padding:10px;border-radius:12px;grid-template-columns:1fr;gap:7px;justify-items:center;align-items:center;text-align:center;background:linear-gradient(180deg,rgba(35,41,51,0.98),rgba(22,27,35,0.98));}',
            ...
            '.tmr-primary-market .tmr-option-odds{font-size:20px;min-width:76px;max-width:100%;padding:8px 12px;border-radius:10px;text-align:center;}',
            ...
            '@media (max-width:1020px){.tmr-market-side{grid-template-columns:1fr;}.tmr-primary-market-grid{max-width:none;width:100%;min-width:0;grid-template-columns:repeat(3,minmax(0,1fr));}.tmr-market-summary{justify-content:space-between;}}',
