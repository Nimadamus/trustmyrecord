...
(function () {
    ...
    var CSS = [
        ...
        'body.tmr-social-profile .profile-header-section{padding:18px 0 0!important;background:transparent!important;}',
        ...
        'body.tmr-social-profile .profile-header{position:relative!important;display:grid!important;grid-template-columns:minmax(0,1fr) 270px!important;gap:18px!important;align-items:stretch!important;overflow:hidden!important;padding:0!important;border:1px solid rgba(148,163,184,.16)!important;border-radius:14px!important;background:linear-gradient(180deg,#111a2e,#0a1322)!important;box-shadow:0 16px 38px rgba(0,0,0,.34)!important;}',
        'body.tmr-social-profile .profile-header:before{content:""!important;display:block!important;position:absolute!important;inset:0 0 auto 0!important;height:118px!important;background:radial-gradient(520px 160px at 18% 15%,rgba(31,184,217,.34),transparent 65%),radial-gradient(420px 160px at 78% 8%,rgba(59,130,246,.22),transparent 70%),linear-gradient(135deg,#0d2346,#101a31 58%,#06101f)!important;border-bottom:1px solid rgba(148,163,184,.14)!important;pointer-events:none!important;}',
        'body.tmr-social-profile .profile-info{position:relative!important;z-index:1!important;padding:72px 24px 22px!important;}',
        'body.tmr-social-profile .profile-identity-row{display:flex!important;align-items:flex-end!important;gap:16px!important;margin-bottom:14px!important;}',
        ...
        'body.tmr-social-profile .profile-rail{position:relative!important;z-index:1!important;padding:132px 18px 18px 0!important;display:grid!important;grid-template-columns:1fr!important;gap:10px!important;}',
        ...
        '@media(max-width:1100px){body.tmr-social-profile .profile-header{grid-template-columns:1fr!important;}body.tmr-social-profile .profile-rail{padding:0 18px 18px!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;}body.tmr-social-profile .profile-body-grid{grid-template-columns:1fr!important;}}',
        '@media(max-width:720px){body.tmr-social-profile .profile-info{padding:64px 16px 18px!important;}body.tmr-social-profile .profile-identity-row{align-items:flex-start!important;flex-direction:column!important;}body.tmr-social-profile .profile-overview-grid,body.tmr-social-profile .profile-rail{grid-template-columns:repeat(2,minmax(0,1fr))!important;}body.tmr-social-profile .profile-avatar{width:86px!important;height:86px!important;min-width:86px!important;}}',
