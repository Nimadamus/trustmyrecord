(function () {
    ...
    var CURRENT_PITCHERS = {
        ARI: [['rodriguez', "Eduardo Rodriguez", 119, 2.7], ['kelly', "Merrill Kelly", 93, 4.88], ['soroka', "Michael Soroka", 117, 2.92], ['littell', "Zack Littell", 94, 4.77], ['pfaadt', "Brandon Pfaadt", 111, 3.36]],
        ATH: [['ginn', "J.T. Ginn", 111, 3.41], ['lopez', "Jacob Lopez", 87, 5.38], ['jump', "Gage Jump", 98, 4.46], ['perkins', "Jack Perkins", 78, 7.04], ['suarez', "José Suarez", 89, 5.22]],
        ATL: [['elder', "Bryce Elder", 103, 4.03], ['holmes', "Grant Holmes", 110, 3.47], ['sale', "Chris Sale", 125, 2.2], ['mahle', "Tyler Mahle", 94, 4.83], ['perez', "Martín Pérez", 114, 3.14]],
        BAL: [['baz', "Shane Baz", 106, 3.76], ['bradish', "Kyle Bradish", 107, 3.69], ['rogers', "Trevor Rogers", 101, 4.21], ['young', "Brandon Young", 110, 3.43], ['garcia', "Rico Garcia", 108, 3.62]],
        BOS: [['gray', "Sonny Gray", 118, 2.79], ['suarez', "Ranger Suarez", 112, 3.32], ['tolle', "Payton Tolle", 113, 3.2], ['bennett', "Jake Bennett", 114, 3.17], ['bello', "Brayan Bello", 94, 4.84]],
        CHC: [['gausman', "Kevin Gausman", 100, 4.29], ['imanaga', "Shota Imanaga", 108, 3.6], ['rea', "Colin Rea", 97, 4.59], ['peterson', "David Peterson", 87, 5.35], ['civale', "Aaron Civale", 90, 5.14]],
        CIN: [['abbott', "Andrew Abbott", 105, 3.92], ['singer', "Brady Singer", 96, 4.66], ['burns', "Chase Burns", 120, 2.61], ['lowder', "Rhett Lowder", 88, 5.26], ['burke', "Brock Burke", 118, 2.84]],
        CLE: [['cantillo', "Joey Cantillo", 105, 3.91], ['williams', "Gavin Williams", 109, 3.55], ['bibee', "Tanner Bibee", 105, 3.85], ['messick', "Parker Messick", 121, 2.57], ['griffin', "Foster Griffin", 112, 3.31]],
        COL: [['lorenzen', "Michael Lorenzen", 78, 6.83], ['freeland', "Kyle Freeland", 78, 6.63], ['sugano', "Tomoyuki Sugano", 97, 4.51], ['feltner', "Ryan Feltner", 83, 5.71], ['hughes', "Gabriel Hughes", 84, 5.61]],
        CWS: [['martin', "Davis Martin", 102, 4.17], ['kay', "Anthony Kay", 104, 3.96], ['burke', "Sean Burke", 115, 3.08], ['castillo', "Luis Castillo", 88, 5.3], ['fedde', "Erick Fedde", 100, 4.3]],
        DET: [['valdez', "Framber Valdez", 102, 4.17], ['montero', "Keider Montero", 111, 3.38], ['melton', "Troy Melton", 130, 1.46], ['anderson', "Drew Anderson", 103, 4.01], ['holton', "Tyler Holton", 118, 2.78]],
        HOU: [['lambert', "Peter Lambert", 115, 3.09], ['imai', "Tatsuya Imai", 85, 5.55], ['brown', "Hunter Brown", 109, 3.53], ['javier', "Cristian Javier", 78, 6.68], ['blanco', "Ronel Blanco", 78, 6.98]],
        KC: [['lugo', "Seth Lugo", 99, 4.41], ['wacha', "Michael Wacha", 110, 3.44], ['cameron', "Noah Cameron", 98, 4.45], ['dobnak', "Randy Dobnak", 128, 2], ['cruz', "Steven Cruz", 101, 4.19]],
        LAA: [['detmers', "Reid Detmers", 104, 4], ['urena', "Walbert Ureña", 118, 2.83], ['rodriguez', "Grayson Rodriguez", 78, 7.2], ['johnson', "Ryan Johnson", 78, 7.11], ['klassen', "George Klassen", 78, 7.27]],
        LAD: [['yamamoto', "Yoshinobu Yamamoto", 120, 2.65], ['sasaki', "Roki Sasaki", 97, 4.54], ['wrobleski', "Justin Wrobleski", 110, 3.44], ['skubal', "Tarik Skubal", 116, 2.93], ['lauer', "Eric Lauer", 93, 4.89]],
        MIA: [['alcantara', "Sandy Alcantara", 109, 3.52], ['perez', "Eury Pérez", 108, 3.61], ['junk', "Janson Junk", 96, 4.63], ['phillips', "Tyler Phillips", 110, 3.47], ['gusto', "Ryan Gusto", 94, 4.78]],
        MIL: [['misiorowski', "Jacob Misiorowski", 130, 1.76], ['may', "Dustin May", 100, 4.3], ['harrison', "Kyle Harrison", 118, 2.84], ['drohan', "Shane Drohan", 105, 3.87], ['gasser', "Robert Gasser", 97, 4.57]],
        MIN: [['bradley', "Taj Bradley", 106, 3.76], ['ober', "Bailey Ober", 98, 4.45], ['prielipp', "Connor Prielipp", 94, 4.79], ['matthews', "Zebby Matthews", 89, 5.23], ['kremer', "Dean Kremer", 89, 5.25]],
        NYM: [['mclean', "Nolan McLean", 109, 3.51], ['scott', "Christian Scott", 110, 3.45], ['manaea', "Sean Manaea", 102, 4.13], ['senga', "Kodai Senga", 78, 8.12], ['thornton', "Zac Thornton", 121, 2.52]],
        NYY: [['schlittler', "Cam Schlittler", 125, 2.21], ['weathers', "Ryan Weathers", 106, 3.79], ['warren', "Will Warren", 101, 4.18], ['fried', "Max Fried", 117, 2.88], ['cole', "Gerrit Cole", 111, 3.35]],
        PHI: [['sanchez', "Cristopher Sánchez", 120, 2.65], ['luzardo', "Jesús Luzardo", 112, 3.32], ['nola', "Aaron Nola", 86, 5.47], ['wheeler', "Zack Wheeler", 119, 2.69], ['painter', "Andrew Painter", 78, 6.27]],
        PIT: [['skenes', "Paul Skenes", 104, 3.96], ['ashcraft', "Braxton Ashcraft", 103, 4.08], ['chandler', "Bubba Chandler", 100, 4.26], ['jones', "Jared Jones", 91, 5.03], ['mlodzinski', "Carmen Mlodzinski", 109, 3.51]],
        SD: [['king', "Michael King", 111, 3.37], ['buehler', "Walker Buehler", 91, 5.07], ['ray', "Robbie Ray", 113, 3.24], ['vasquez', "Randy Vásquez", 102, 4.16], ['mize', "Casey Mize", 111, 3.38]],
        SEA: [['gilbert', "Logan Gilbert", 111, 3.42], ['kirby', "George Kirby", 107, 3.68], ['woo', "Bryan Woo", 100, 4.31], ['hancock', "Emerson Hancock", 111, 3.35], ['miller', "Bryce Miller", 115, 3.08]],
        SF: [['roupp', "Landen Roupp", 101, 4.22], ['webb', "Logan Webb", 109, 3.59], ['houser', "Adrian Houser", 97, 4.55], ['whisenhunt', "Carson Whisenhunt", 78, 7.25], ['tidwell', "Blade Tidwell", 118, 2.78]],
        STL: [['mcgreevy', "Michael McGreevy", 108, 3.64], ['liberatore', "Matthew Liberatore", 90, 5.15], ['pallante', "Andre Pallante", 108, 3.63], ['leahy', "Kyle Leahy", 110, 3.45], ['dobbins', "Hunter Dobbins", 111, 3.4]],
        TB: [['peralta', "Freddy Peralta", 88, 5.33], ['martinez', "Nick Martinez", 120, 2.65], ['rasmussen', "Drew Rasmussen", 119, 2.75], ['matz', "Steven Matz", 85, 5.55], ['seymour', "Ian Seymour", 103, 4.08]],
        TEX: [['gore', "MacKenzie Gore", 98, 4.43], ['degrom', "Jacob deGrom", 105, 3.87], ['rocker', "Kumar Rocker", 98, 4.46], ['quantrill', "Cal Quantrill", 109, 3.56], ['alexander', "Tyler Alexander", 114, 3.16]],
        TOR: [['soriano', "José Soriano", 113, 3.24], ['cease', "Dylan Cease", 124, 2.28], ['taillon', "Jameson Taillon", 83, 5.68], ['richardson', "Simeon Woods Richardson", 78, 6.23], ['bieber', "Shane Bieber", 86, 5.48]],
        WSH: [['cavalli', "Cade Cavalli", 109, 3.57], ['irvin', "Jake Irvin", 87, 5.37], ['mikolas', "Miles Mikolas", 81, 5.89], ['alvarez', "Andrew Alvarez", 106, 3.76], ['lord', "Brad Lord", 106, 3.79]]
    };
