...
(function () {
    ...
    css.textContent = [
        ...
        // CONTEST_BANNER_UNSTICK_20260918: the banner is 417px tall on a 768px laptop, 869px on a tablet and
        // 1084px on a phone. Sticky, it covered the board at every size; it scrolls away with the page now.
        ...
        banner.innerHTML =
            ...
            '<div class="tmr-cm-text">' +
                ...
                '<ol class="tmr-cm-rules">' +
                    ...
                    '<li><strong>50 picks</strong> per entrant. MLB only. <strong>All 50 are mandatory:</strong> anyone with fewer than 50 picks at the end is not eligible for a prize.</li>' +
