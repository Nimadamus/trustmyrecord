...
(function () {
  ...
  function legacyBoot() {
    ...
    // ONE request carries both stripe figures it owns. Picks tracked and
    // members come from the same response so they can't be served from two
    // different snapshots, and there is no second endpoint left that could
    // supply a different pick count.
