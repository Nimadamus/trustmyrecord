...
(function () {
  ...
  var HANDICAPPERS = [
    ...
    /* Picks bought and sold in TMR, live 2026-08-19. A SEPARATE entry rather
       than a rename of 'Buy Picks': the cash marketplace keeps running exactly
       as it did, and folding the two together would hide whichever rail a
       member was actually looking for. Sits here beside the other two so a
       seller pricing in TMR and a buyer spending TMR find it in the same place
       they already look for picks, rather than needing the URL. */
    ['/marketplace/tmr/', 'Picks for TMR']
  ];
  var COMPETE = [
  ...
  var NOTIF_CHAIN = [
    ...
    '/static/js/backend-api.js?v=3cbc527ee17a',
