...
- Any messaging/nav change must include live browser verification that homepage Log in and Sign up/Join Free still work. HTML anchor presence, source checks, or HTTP fetches are not valid verification for click behavior.
