...
- Full game totals must never display as only "Under 5.5" or "Over 5.5".
- Full game totals must include "Full Game Total" and should include matchup context when possible.
